...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    generated_perc = ((voltage*current)/theoretical_max_power)*100

    if generated_perc >= 80:
        return "green"
    elif generated_perc < 80 and generated_perc >= 60:
        return "orange"
    elif generated_perc < 60 and generated_perc >= 30:
        return "red"
    return "black"
